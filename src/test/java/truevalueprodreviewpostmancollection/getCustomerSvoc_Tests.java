...
public class getCustomerSvoc_Tests extends StatusCodeClass  {

    private Response response;
    private ExtentTest test;

    @Test(priority=1)
    public void getCustomerSvoc_buyingId_B25018246679() {
        ...
        try {
            response = given()
                    ...
                    .when().post("https://s1sgfdgek6.execute-api.ap-south-1.amazonaws.com/prod/api/external/getCustomerSvoc?buyingId=B25018246679")
            ...
            Assert.fail("API Failed: getCustomerSvoc_buyingId_B25018246679");
        }
    }
