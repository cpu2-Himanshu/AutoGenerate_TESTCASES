...
public class getchecklist_Tests extends StatusCodeClass  {

    private Response response;
    private ExtentTest test;

    @Test(priority=1)
    public void getChecklist_state_common_buyingId() {
        ...
        try {
            response = given()
                    ...
                    .when().get("https://s1sgfdgek6.execute-api.ap-south-1.amazonaws.com/prod/api/document/getChecklist?state=common&buyingId=B25017733016")
            ...
            Assert.fail("API Failed: getChecklist_state_common_buyingId");
        }
    }
