...
public class vahaninfo_Tests extends StatusCodeClass  {

    private Response response;
    private ExtentTest test;

    @Test(priority=1)
    public void vahanInfo() {
        test = ExtentLiistener.getTest();
        RestAssured.baseURI = BASE_URI;

        String Payload = "{\"buyingId\":\"B25018246679\",\"splitAddress\":true}";
        ...
        try {
            response = given()
                    ...
                    .body(Payload)
                    .when().post("https://s1sgfdgek6.execute-api.ap-south-1.amazonaws.com/prod/api/external/vahanInfo")
            ...
            Assert.fail("API Failed: vahanInfo");
        }
    }
